...
if [ -d "$ramdisk_path" ]; then
	...
	wget https://github.com/opa334/TrollStore/releases/download/2.1/PersistenceHelper_Embedded
	wget https://github.com/opa334/TrollStore/releases/download/2.1/TrollStore.tar
